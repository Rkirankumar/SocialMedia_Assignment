package com.socialmediaassignment.utils;
...
import com.socialmediaassignment.adapter.CommentsPlayerViewHolder;
...
public class ExoCommentPlayerRecyclerView extends RecyclerView {

  private static final String TAG = "ExoPlayerRecyclerView";
  private static final String AppName = "Android ExoPlayer";
  /**
   * CommentsPlayerViewHolder UI component
   * Watch CommentsPlayerViewHolder class
   */
  ...
  public ExoCommentPlayerRecyclerView(@NonNull Context context) {
    super(context);
    init(context);
  }

  public ExoCommentPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }
  ...
  public void playVideo(boolean isEndOfList) {
    ...
    CommentsPlayerViewHolder holder = (CommentsPlayerViewHolder) child.getTag();
    if (holder == null) {
      playPosition = -1;
      return;
    }
   mediaCoverImage = holder.mediaCoverImage;
    ...
    DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(
     ...
     if (commentsObjects.get(targetPosition).getUrl() != null) {
